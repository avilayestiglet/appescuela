...
const ModalInfoComponent = ({show}) => {
  return (
    <div className="fixed top-0 left-0 z-999999 flex h-full min-h-screen w-full items-center justify-center bg-black/90 px-4 py-5 hidden">
      <div className="relative w-1/2 max-w-142.5 rounded-lg bg-primary py-12 px-8 text-center md:py-15 md:px-17.5">
        ...
        <button className="absolute top-6 right-6 flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-white hover:text-primary">
          <svg
            width="10"
            height="10"
            viewBox="0 0 13 13"
