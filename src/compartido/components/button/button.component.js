...
const roles = {
    primary: "block w-full bg-yellow-400 py-2 px-6 rounded-2xl text-white font-semibold mb-4 hover:shadow-xl hover:-translate-y-[0.2] hover:-translate-x-[0.2] transition-all duration-300",
